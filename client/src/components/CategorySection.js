                    ...
                    <div className="absolute bottom-0 inset-x-0 p-4 text-center">
                      <div className="mb-2 opacity-0 translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
                        <Link to={`/products?category=${category.slug}`}>
                          <button className="bg-white text-gray-800 hover:bg-gray-100 border border-gray-300 px-4 py-2 rounded">
                            Shop Now
                          </button>
                        </Link>
                      </div>
                              ...
                              {hoveredSubcategory === "gender" && (
                                <div className="pl-4 space-y-1 text-sm">
                                  {category.subcategories.gender.map((gender) => (
                                    <Link
                                      key={gender}
                                      to={`/products?category=${category.slug}&gender=${gender.toLowerCase()}`}
                              ...
                              {hoveredSubcategory === "ageGroups" && (
                                <div className="pl-4 space-y-1 text-sm">
                                  {category.subcategories.ageGroups.map((age) => (
                                    <Link
                                      key={age}
                                      to={`/products?category=${category.slug}&ageGroup=${age.toLowerCase().replace(/\s+/g, "-").replace(/[()]/g, "")}`}
                                      className="block text-gray-800 hover:text-teal-700"
                                    >
                                      {age}
                                    </Link>
                              ...
                              {hoveredSubcategory === "types" && (
                                <div className="pl-4 space-y-1 text-sm">
                                  {category.subcategories.types.map((type) => (
                                    <Link
                                      key={type}
                                      to={`/products?category=${category.slug}&type=${type.toLowerCase()}`}
                                      className="block text-gray-800 hover:text-teal-700"
                                    >
                                      {type}
                                    </Link>
                              ...
                              {hoveredSubcategory === "services" && (
                                <div className="pl-4 space-y-1 text-sm">
                                  {category.subcategories.services.map((service) => (
                                    <Link
                                      key={service}
                                      to={`/products?category=${category.slug}&service=${service.toLowerCase().replace(/\s+/g, "-")}`}
                                      className="block text-gray-800 hover:text-teal-700"
                                    >
                                      {service}
                                    </Link>
                              ...
                              {hoveredSubcategory === "benefits" && (
                                <div className="pl-4 space-y-1 text-sm">
                                  {category.subcategories.benefits.map((benefit) => (
                                    <Link
                                      key={benefit}
                                      to={`/gold-membership?highlight=${benefit.toLowerCase().replace(/\s+/g, "-").replace(/[%]/g, "")}`}
                                      className="block text-gray-800 hover:text-teal-700"
                                    >
                                      {benefit}
                                    </Link>
                              ...
                              {hoveredSubcategory === "topPicks" && (
                                <div className="pl-4 space-y-1 text-sm">
                                  {category.subcategories.topPicks.map((pick) => (
                                    <Link
                                      key={pick}
                                      to={`/products?category=${category.slug}&topPick=${pick.toLowerCase().replace(/\s+/g, "-")}`}
                                      className="block text-gray-800 hover:text-teal-700"
                                    >
                                      {pick}
                                    </Link>
                              ...
                              {hoveredSubcategory === "frameTypes" && (
                                <div className="pl-4 space-y-1 text-sm">
                                  {category.subcategories.frameTypes.map((type) => (
                                    <Link
                                      key={type}
                                      to={`/products?category=${category.slug}&frameType=${type.toLowerCase().replace(/\s+/g, "-")}`}
                                      className="block text-gray-800 hover:text-teal-700"
                                    >
                                      {type}
                                    </Link>
                                    ...
                                    <div>
                                      ...
                                      <div className="pl-2 space-y-1">
                                        {category.subcategories.collections.styles.map((style) => (
                                          <Link
                                            key={style}
                                            to={`/products?category=${category.slug}&style=${style.toLowerCase().replace(/\s+/g, "-")}`}
                                            className="block text-gray-800 hover:text-teal-700"
                                          >
                                            {style}
                                          </Link>
                                    ...
                                    <div>
                                      ...
                                      <div className="pl-2 space-y-1">
                                        {category.subcategories.collections.brands.map((brand) => (
                                          <Link
                                            key={brand}
                                            to={`/products?category=${category.slug}&brand=${brand.toLowerCase().replace(/\s+/g, "-")}`}
                                            className="block text-gray-800 hover:text-teal-700"
                                          >
                                            {brand}
                                          </Link>
                              ...
                              {hoveredSubcategory === "seasonal" && (
                                <div className="pl-4 space-y-1 text-sm">
                                  {category.subcategories.seasonal.map((season) => (
                                    <Link
                                      key={season}
                                      to={`/products?category=${category.slug}&season=${season.toLowerCase().replace(/\s+/g, "-")}`}
                                      className="block text-gray-800 hover:text-teal-700"
                                    >
                                      {season}
                                    </Link>
