...
function AboutPage() {
  return (
    <div className="container px-4 md:px-6 py-8 pt-160">
        ...
        <div className="md:w-1/3">
          ...
          <div className="contact-info space-y-4">
            ...
            <div className="flex space-x-4 mt-4">
              <Link to="https://facebook.com" className="text-gray-600 hover:text-gray-900 transition-colors">
                <Facebook size={24} />
              </Link>
              <Link to="https://instagram.com" className="text-gray-600 hover:text-gray-900 transition-colors">
                <Instagram size={24} />
              </Link>
              <Link to="https://twitter.com" className="text-gray-600 hover:text-gray-900 transition-colors">
                <Twitter size={24} />
              </Link>
              <Link to="https://wa.me/254712345678" className="text-gray-600 hover:text-gray-900 transition-colors">
                <svg
