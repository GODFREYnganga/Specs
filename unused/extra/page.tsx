		...
		<div className="space-y-6">
			...
			<Card>
				...
				<CardContent className="space-y-4">
					...
					>
					...
					</Button>					{uploadedImages.length > 0 && (
						<div className="border rounded-lg p-4 bg-green-50">
							...
							<div className="grid grid-cols-1 gap-2">
								{uploadedImages.map((imagePath, index) => (
									<div key={index} className="flex items-center justify-between p-2 bg-white rounded border">
										<span className="text-sm font-mono text-gray-700">{imagePath}</span>
										<Button
											size="sm"
											variant="outline"
							...
							<p className="text-xs text-green-700 mt-2">
								Use these paths in your Excel file's "Images" column (comma-separated for multiple images)
							</p>
						</div>
					)}
				</CardContent>
			</Card>			{/* Excel Upload Section */}
			<Card>
				<CardHeader>
					<CardTitle>Bulk Product Upload</CardTitle>
					<p className="text-sm text-gray-600">
						Upload your Excel file with product data. Make sure to include image paths in the "Images" column.
					</p>
				</CardHeader>
				<CardContent className="space-y-4">
					{/* Instructions */}
					<div className="border rounded-lg p-4 bg-blue-50">
						...
						<ol className="text-sm text-blue-700 space-y-1 list-decimal list-inside">
							<li>First, upload your product images using the section above</li>
							<li>Copy the image paths and add them to your Excel file's "Images" column</li>
							<li>For multiple images per product, separate paths with commas</li>
							<li>Download the template below to see the required column format</li>
					...
					<div className="flex items-center gap-4">
						<Button
							variant="outline"
							onClick={() => window.open('/api/products/csv-template', '_blank')}
						>
