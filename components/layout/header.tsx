    ...
    <div className="p-6 grid grid-cols-4 gap-8">
      ...
      <div>
        ...
        <div className="grid gap-4">
          <div className="flex items-center space-x-3">
            ...
            <Link href="/products?category=eyeglasses&gender=men" className="text-sm hover:text-gray-900">
              Men
            </Link>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <Link href="/products?category=eyeglasses&gender=women" className="text-sm hover:text-gray-900">
              Women
            </Link>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <Link href="/products?category=eyeglasses&gender=kids" className="text-sm hover:text-gray-900">
              Kids
            </Link>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="grid gap-2 text-sm">
          <Link href="/products?category=eyeglasses&topPick=new-arrivals" className="hover:text-gray-900">
            New Arrivals
          </Link>
          <Link href="/products?category=eyeglasses&topPick=best-sellers" className="hover:text-gray-900">
            Best Sellers
          </Link>
          <Link href="/products?category=eyeglasses&topPick=progressive-eyeglasses" className="hover:text-gray-900">
      ...
      <div>
        ...
        <div className="grid gap-2 text-sm">
          <Link href="/products?category=eyeglasses&frameType=rectangle-frames" className="hover:text-gray-900">
            Rectangle Frames
          </Link>
          <Link href="/products?category=eyeglasses&frameType=square-frames" className="hover:text-gray-900">
            Square Frames
          </Link>
          <Link href="/products?category=eyeglasses&frameType=round-frames" className="hover:text-gray-900">
            Round Frames
          </Link>
          <Link href="/products?category=eyeglasses&frameType=cat-eye-frames" className="hover:text-gray-900">
            Cat Eye Frames
          </Link>
          <Link href="/products?category=eyeglasses&frameType=wayfarer-frames" className="hover:text-gray-900">
            Wayfarer Frames
          </Link>
          <Link href="/products?category=eyeglasses&frameType=geometric-frames" className="hover:text-gray-900">
            Geometric Frames
          </Link>
          <Link href="/products?category=eyeglasses&frameType=aviator-frames" className="hover:text-gray-900">
            Aviator Frames
          </Link>
          <Link href="/products?category=eyeglasses&frameType=halfrim-frames" className="hover:text-gray-900">
            Halfrim Frames
          </Link>
          <Link href="/products?category=eyeglasses&frameType=rimless-frames" className="hover:text-gray-900">
            Rimless Frames
          </Link>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="grid gap-2 text-sm">
            <Link href="/products?category=eyeglasses&style=matte-classics" className="hover:text-gray-900">
              Matte Classics
            </Link>
            <Link href="/products?category=eyeglasses&style=urban-steel" className="hover:text-gray-900">
              Urban Steel
            </Link>
            <Link href="/products?category=eyeglasses&style=acetate-classics" className="hover:text-gray-900">
              Acetate Classics
            </Link>
            <Link href="/products?category=eyeglasses&style=youth-trends" className="hover:text-gray-900">
              Youth Trends
            </Link>
            <Link href="/products?category=eyeglasses&style=bold-patterns" className="hover:text-gray-900">
              Bold Patterns
            </Link>
            <Link href="/products?category=eyeglasses&style=modern-minimal" className="hover:text-gray-900">
              Modern Minimal
            </Link>
            <Link href="/products?category=eyeglasses&style=everyday-comfort" className="hover:text-gray-900">
              Everyday Comfort
            </Link>
            <Link href="/products?category=eyeglasses&style=executive-edit" className="hover:text-gray-900">
              Executive Edit
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="grid gap-2 text-sm">
            <Link href="/products?category=eyeglasses&brand=fashionista-classic" className="hover:text-gray-900">
              Fashionista Classic
            </Link>
            <Link href="/products?category=eyeglasses&brand=magneto-kids-classic" className="hover:text-gray-900">
              Magneto Kids Classic
            </Link>
            <Link href="/products?category=eyeglasses&brand=magneto-kids-premium" className="hover:text-gray-900">
          ...
          <div className="flex justify-between items-center">
            <div className="flex space-x-8 py-4 text-sm font-medium flex-grow text-gray-800">
              ...
              <div className="group relative">
                <Link href="/products?category=eyeglasses" className="text-white hover:text-gray-600">
                  EYE GLASSES
                </Link>
              ...
              <Link href="/products?category=screen" className="text-white hover:text-gray-600">
                SCREEN GLASSES
              </Link>

              <Link href="/products?category=kids" className="text-white hover:text-gray-600">
                KIDS GLASSES
              </Link>

              {/* CONTACT LENSES Dropdown */}
              <div className="group relative">
                <Link href="/products?category=contact" className="text-white hover:text-gray-600">
                  CONTACT LENSES
                </Link>
                <div className="absolute left-0 top-full w-[800px] bg-white shadow-lg rounded-b-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
